...
uint256 hashGenesisBlock("0x0000000097cfeb76fd7549d30731cb9bf5060b801092b897a68b077f82619924");
...
const string strMessageMagic = "AntiBeebaCoin Signed Message:\n";
...
{
    int64 nSubsidy = 2112 * COIN;

    // Subsidy is cut in half every 139115 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 139115);
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0000000097cfeb76fd7549d30731cb9bf5060b801092b897a68b077f82619924");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1394010484;
        block.nBits    = 486604799;
        block.nNonce   = 1301606009;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("AntiBeebaCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("AntiBeebaCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("AntiBeebaCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running AntiBeebaCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("AntiBeebaCoinMiner terminated\n");
        throw;
    }
}
